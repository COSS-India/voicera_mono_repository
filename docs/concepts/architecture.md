...
All services run on one host via `../../legacy/docker-compose.yml`. Good for trials, demos, and small production deployments. See [docker-compose.md](../guides/deployment/docker-compose.md).
